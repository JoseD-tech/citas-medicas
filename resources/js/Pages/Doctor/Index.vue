                ...
                <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                    ...
                    <div class="mt-6 flex items-center justify-start w-full">
                        <button @click="guardarCita"
                            class="focus:outline-none focus:ring-2 focus:ring-green-2 focus:ring-green-700 transition duration-150 ease-in-out hover:bg-green-600 bg-green-700 rounded text-white px-8 py-2 text-sm">Guardar Consulta</button>
                        <button
